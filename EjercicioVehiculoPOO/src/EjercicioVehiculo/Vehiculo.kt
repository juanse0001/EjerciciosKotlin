...
abstract class Vehiculo(
    ...
    private var estaDañado: Boolean = false
    ...
    fun bajarMarcha() {
        if (estaDañado) {
            println("¡$marca $modelo está dañado y no puede cambiar de marcha!")
            return
        }
        if (marchaActual > 0) {
            marchaActual--
    ...
    fun obtenerInformacion(): String {
        return "Marca: $marca, Modelo: $modelo, Año: $año, Velocidad Actual: $velocidadActual km/h, Marcha Actual: $marchaActual, ¿Está roto? $estaDañado"
    }
}