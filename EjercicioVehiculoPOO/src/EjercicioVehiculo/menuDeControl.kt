...
fun menuDeControl() {
    ...
    var vehiculo = seleccionarVehiculo(coche, moto, camion)

    while (true) {
        mostrarMenu(vehiculo)
        ...
        when (opcion) {
            ...
            14 -> vehiculo = seleccionarVehiculo(coche, moto, camion)
            0 -> {
        ...
        println("¿Deseas realizar otra acción? (si/no)")
...
fun seleccionarVehiculo(coche: Coche, moto: Motocicleta, camion: Camion): Vehiculo {
...
fun mostrarMenu(vehiculo: Vehiculo) {
